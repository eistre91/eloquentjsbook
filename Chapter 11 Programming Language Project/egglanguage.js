...
//   if (first == null || first.index > 0) {console.log("string:" + string); return string;}
//   console.log("slice return:" + string.slice(first[0].length));
...
console.log("log:" + Object.getPrototypeOf(topEnv));
...
specialForms["set"] = function(args, env) {
  ...
  throw new ReferenceError("Variable: " + args[0].name + " does not exist.");
};
